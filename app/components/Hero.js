               ...
               <div className={styles.heroContentWrapper}>
                 <div className={styles.heroGrid}>
                   <div className={styles.heroGridFirstChild}>
                     <div>
                       ...
                       <div className={`${styles.heroActions} ${styles.whatsappButtonsGroup}`}>
                         <button 
                           className="cta whatsapp-icon-only" 
                           onClick={handleWhatsAppClick}
                           aria-label="Contacter via WhatsApp - Icône uniquement"
                         >
                           <span className="icon-square icon-square-red" aria-hidden="true">
                         ...
                         <button 
                           className="cta whatsapp-text-only" 
                           onClick={handleWhatsAppClick}
                           aria-label="Contacter via WhatsApp immédiatement"
                         >
                   ...
                   <div className={styles.heroImage}>
                     <Image 
                       src={heroImg} 
                       alt="Projet immobilier EM IMMO - Résidence moderne à Marrakech" 
                       fill
                       priority 
                       quality={90}
